...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s3 = new Seller(3, "Alex Grey", "alex@gmail.com", new DateTime(1999, 1, 15), 3000.0, d1);
            Seller s4 = new Seller(4, "Martha Red", "martha@gmail.com", new DateTime(1983, 11, 30), 4500.0, d4);
            Seller s5 = new Seller(5, "Donald Blue", "donald@gmail.com", new DateTime(1987, 1, 9), 2500.0, d3);
            Seller s6 = new Seller(6, "Arnold Pink", "arnold@gmail.com", new DateTime(1996, 3, 4), 3400.0, d2);
